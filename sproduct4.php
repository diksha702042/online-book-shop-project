...
$res=mysql_query("select * from addproduct1 where name='Beyond Infinity';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="sproduct4.php">
...
Discoveries in Cosmology can raise mankind to greater 
heights. It will have great significance and intellect 
at particular times. In this book, you will be forced 
to reveal the truth of the universe and you will be 
able to think apart from daily stuff. 
      </pre>
