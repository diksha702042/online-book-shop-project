...
$res=mysql_query("select * from addproduct1 where name='the constitution of india';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="hhproduct4.php">
...
fundamental rights, directive principles and the duties 
of citizens. 
      </pre>
