...
$res=mysql_query("select * from addproduct1 where name='Time Trap';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="sproduct3.php">
...
A time travel fantasy that is a fast-actionthriller 
as much as a romantic tale.Rayen awakens in an 
unfamiliar world called Albuquerque and is captured 
then stuck in an institute for strange students 
while they search for her family. 
      </pre>
