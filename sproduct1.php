...
$res=mysql_query("select * from addproduct1 where name='Encyclopedia of General Science for General Compet';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="sproduct1.php">
...
This book is an ideal book for competitive examinations 
like NEET, UPSC and state level civil service 
examinations, SSC, Railway etc. It covers numerous 
subjects as physics, chemistry, biology. It has more 
than 1300 multiple choice questions. 
      </pre>
