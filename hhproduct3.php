...
$res=mysql_query("select * from addproduct1 where name='gulamgiri';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="hhproduct3.php">
...
Discover Albert Einstein's groundbreaking 
theories with "Relativity: The Special and
the General Theory." This influential work
provides a comprehensive exploration of the 
principles that revolutionized our understanding
