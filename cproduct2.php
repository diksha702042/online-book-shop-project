...
$res=mysql_query("select * from addproduct1 where name='Super Easy Receipes';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="cproduct2.php">
...
Learn to Cook Fast and Easy!
Cooking for yourself and your loved ones doesnt 
have to be a chore. It shouldnt make you nervous 
right off the bat. Nobody was born with exceptional 
cooking skills; we all had to hone them over time, 
even the best chefs!

✓ ✓ ✓ If you want to know how to cook dishes that 
are not only easy to make but embody the basics of 
cooking, you’ve found the right book. 
      </pre>
