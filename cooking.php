...
<body>
    ...
    <div id="menu">
        ...
        <br><br>
        <center><h1 id="hh">Cooking Books</h1></center>         
  
<div id=allproduct>
             
    <div id="container">
    <div id="product">
    <a href="cproduct1.php"><img src="images/24.jpg" id="img1"></a>
    INDIAN Cooking
    </div></div>

    <div id="container">
    <div id="product">
    <a href="cproduct2.php"><img src="images/5.jpeg" id="img1"></a>
    Super Easy Receipes
    </div></div>
    
    <div id="container">
    <div id="product">
    <a href="cproduct3.php"><img src="images/10.jpeg" id="img1"></a>
    South Indian Cooking
    </div></div>
    
    <div id="container">
    <div id="product">
    <a href="cproduct4.php"><img src="images/9.jpeg" id="img1"></a>
    The Andra Cooking
    </div></div>
