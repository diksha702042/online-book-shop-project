...
<body>
    ...
    <div id="menu">
        ...
        <br><br>
        <center><h1 id="hh">New Arrivals</h1></center>         
  
<div id=allproduct>
             
    <div id="container">
    <div id="product">
    <a href="hproduct1.php"><img src="images/42.jpg" id="img1"></a><br>
     A Brief History of Time 	
    </div></div>

    <div id="container">
    <div id="product">
    <a href="hproduct2.php"><img src="images/41.jpg" id="img1"></a>
    Wings Of Fire
    </div></div>
    
    <div id="container">
    <div id="product">
    <a href="hproduct3.php"><img src="images/7.jpeg" id="img1"></a>
    Kyra
    </div></div>
    
    <div id="container">
    <div id="product">
    <a href="hproduct4.php"><img src="images/2.jpeg" id="img1"></a>
    Sherlock Holmes
    </div></div>
