...
$res=mysql_query("select * from addproduct1 where name='digital marketing';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="eproduct1.php">
...
1. E-Commerce - 
2. Introduction to New Age Media (Digital) Markrting - 
3. Creating Initial Digital Marketing Plan - 
4. Markrting using Web Sites - 
5. Search Engine Optimization - 
6. Customer Relationship Management - 
7. Social Media Marketing - 
8. Digital Marketing Budgeting
      </pre>
