...
<body>
    ...
    <div id="menu">
        ...
        <br><br>
        <center><h1 id="hh">Educational Books</h1></center>         
  
<div id=allproduct>
             
    <div id="container">
    <div id="product">
    <a href="eproduct1.php"><img src="images/39.jpg" id="img1"></a>
    Core Java
    </div></div>

    <div id="container">
    <div id="product">
    <a href="eproduct2.php"><img src="images/40.jpg" id="img1"></a>
    Python
    </div></div>
    
    <div id="container">
    <div id="product">
    <a href="eproduct3.php"><img src="images/30.jpg" id="img1"></a>
    Relational Database
    </div></div>
    
    <div id="container">
    <div id="product">
    <a href="eproduct4.php"><img src="images/29.jpg" id="img1"></a>
    C Programming
    </div></div>
