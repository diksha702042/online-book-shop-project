...
<body>
    ...
    <div id="menu">
        ...
        <br><br>
        <center><h1 id="hh">History Books</h1></center>         
  
<div id=allproduct>
             
    <div id="container">
    <div id="product">
    <a href="hhproduct1.php"><img src="images/33.jpg" id="img1"></a>
    Modern Indian History
    </div></div>

    <div id="container">
    <div id="product">
    <a href="hhproduct2.php"><img src="images/34.jpg" id="img1"></a>
    Ancient INDIA History
    </div></div>
    
    <div id="container">
    <div id="product">
    <a href="hhproduct3.php"><img src="images/37.jpg" id="img1"></a>
    Gulamgiri
    </div></div>
    
    <div id="container">
    <div id="product">
    <a href="hhproduct4.php"><img src="images/43.jpg" id="img1"></a>
