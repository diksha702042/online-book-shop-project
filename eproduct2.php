...
$res=mysql_query("select * from addproduct1 where name='Object Oriented Software Engineering';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="eproduct2.php">
...
1. Introduction and basics of Software Modelling - 
2. SRS Documentation - 
3. Introduction to UML - 
4. Object Oriented Concepts and Principles - 
5. Structural Modelling - 
6. Basic Behavioral Modeling - 
7. Architectural Modeling - 
8. Object Oriented Analysis - 
9. Object Oriented Design - Bibliography
      </pre>
