...
$res=mysql_query("select * from addproduct1 where name='advance c programming';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="eproduct4.php">
...
The book has its own unique features. It brings out 
the subject in a very simple and lucid manner for 
easy and comprehensive understanding of the basic 
concepts, its intricacies, procedures and practices. 
This book will help the readers to have a broader 
view on advance C programming. 
      </pre>
