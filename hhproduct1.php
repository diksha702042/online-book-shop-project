...
$res=mysql_query("select * from addproduct1 where name='Modern Indian History';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="hhproduct1.php">
...
Description
 ...
 Modern History 2023 book launched by Study IQ Publications 
 aims to address the syllabus of modern history 
 holistically from the UPSC Civil Services Examinations 
 perspective. The book has been updated as per the latest 
 examination pattern. This book is specially designed for 
 the main appearing aspirants.
      </pre>
