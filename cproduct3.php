...
$res=mysql_query("select * from addproduct1 where name='South Indian Cooking';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="cproduct3.php">
...
All of our paper waste is recycled within the UK 
and turned into corrugated cardboard. We all like 
the idea of saving a bit of cash, so when we found 
out how many good quality used products are out 
there - we just had to let you know!
