...
$res=mysql_query("select * from addproduct1 where name='INDIAN Cooking';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="cproduct1.php">
...
Classic recipes from the many regions of a diverse 
and culturally rich nation. Indian cuisine is widely 
revered for its distinctive tastes and ingredients. 
The sheer size of India, combined with its history 
and religious diversity, is reflected in the country's 
cuisine. 
      </pre>
