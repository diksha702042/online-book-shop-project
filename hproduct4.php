...
$res=mysql_query("select * from addproduct1 where name='sherlock holmes';");
            while($row=mysql_fetch_array($res)){
?>

     <table><tr><td id="bimg">

    <form method="post" action="hproduct4.php">
  ...
  Welcome back to Vrigin River with the book
  that inspired the hit Netflix series ...John 
  "Preacher" Middleton is closing Jack's Bar when
  a women and her young son come in out of the white
  night.
      </pre>
